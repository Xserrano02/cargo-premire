    ...
    <footer>
      <div className="container__footer">
        <section className="d-flex justify-content-between flex-column flex-lg-row p-4 text-white" >
          ...
          <div id="social-icons">
            <a href="#" className="text-white me-4"><i className="fab fa-facebook"></i></a>
        ...
        <section className="container">
          <div className="container text-center text-md-start mt-5">
            <div className="row mt-3">
              ...
              <div className="col-md-4 col-lg-4 col-xl-4 mx-auto mb-4">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2993.686291279216!2d2.120244875533621!3d41.380899996398384!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x12a498f576297baf%3A0x44f65330fe1b04b9!2sSpotify%20Camp%20Nou!5e0!3m2!1ses-419!2ssv!4v1713680177502!5m2!1ses-419!2ssv" width="100%" height="100%" style={{ border: '0' }} allowFullScreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
              </div>
            </div>
          </div>
        </section>
